...
DocumentReference? get currentUserReference =>
    loggedIn ? UserCredentialRecord.collection.doc(currentUser!.uid) : null;

UserCredentialRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : UserCredentialRecord.getDocument(
                  UserCredentialRecord.collection.doc(uid))
              .handleError((_) {}),
    )
    .map((user) {
