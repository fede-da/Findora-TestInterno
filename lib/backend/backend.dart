...
import 'schema/user_credential_record.dart';
...
import 'schema/vendor_questionnaire_record.dart';
...
export 'schema/user_credential_record.dart';
...
export 'schema/vendor_questionnaire_record.dart';
export 'schema/reviews_record.dart';

/// Functions to query UserCredentialRecords (as a Stream and as a Future).
Future<int> queryUserCredentialRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      UserCredentialRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<UserCredentialRecord>> queryUserCredentialRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      UserCredentialRecord.collection,
      UserCredentialRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<UserCredentialRecord>> queryUserCredentialRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<UserCredentialRecord>> queryUserCredentialRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
  required PagingController<DocumentSnapshot?, UserCredentialRecord> controller,
    ...
    queryCollectionPage(
      ...
      if (isStream) {
        final streamSubscription =
            (page.dataStream)?.listen((List<UserCredentialRecord> data) {
          data.forEach((item) {
...
Future<int> queryCategoryItemRecordCount({
  ...
  int limit = -1,
    ...
    queryCollectionCount(
      CategoryItemRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );
...
Future<FFFirestorePage<CategoryItemRecord>> queryCategoryItemRecordPage({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
  required PagingController<DocumentSnapshot?, CategoryItemRecord> controller,
  List<StreamSubscription?>? streamSubscriptions,
}) =>
    queryCollectionPage(
      CategoryItemRecord.collection(parent),
      ...
      if (isStream) {
        final streamSubscription =
            (page.dataStream)?.listen((List<CategoryItemRecord> data) {
          data.forEach((item) {
            final itemIndexes = controller.itemList!
                .asMap()
                .map((k, v) => MapEntry(v.reference.id, k));
...
/// Functions to query VendorQuestionnaireRecords (as a Stream and as a Future).
Future<int> queryVendorQuestionnaireRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      VendorQuestionnaireRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<VendorQuestionnaireRecord>> queryVendorQuestionnaireRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      VendorQuestionnaireRecord.collection,
      VendorQuestionnaireRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<VendorQuestionnaireRecord>> queryVendorQuestionnaireRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<VendorQuestionnaireRecord>>
    queryVendorQuestionnaireRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
  required PagingController<DocumentSnapshot?, VendorQuestionnaireRecord>
      controller,
  List<StreamSubscription?>? streamSubscriptions,
}) =>
        queryCollectionPage(
          ...
          if (isStream) {
            final streamSubscription = (page.dataStream)
                ?.listen((List<VendorQuestionnaireRecord> data) {
              data.forEach((item) {
                final itemIndexes = controller.itemList!
                    .asMap()
                    .map((k, v) => MapEntry(v.reference.id, k));
...
Future maybeCreateUser(User user) async {
  final userRecord = UserCredentialRecord.collection.doc(user.uid);
  final userExists = await userRecord.get().then((u) => u.exists);
  if (userExists) {
    currentUserDocument =
        await UserCredentialRecord.getDocumentOnce(userRecord);
    return;
  }

  final userData = createUserCredentialRecordData(
    email: user.email ??
  ...
  currentUserDocument =
      UserCredentialRecord.getDocumentFromData(userData, userRecord);
}

Future updateUserDocument({String? email}) async {
  await currentUserDocument?.reference
      .update(createUserCredentialRecordData(email: email));
}
