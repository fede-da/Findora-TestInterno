...
import 'profile18_user_details_other_model.dart';
export 'profile18_user_details_other_model.dart';

class Profile18UserDetailsOtherWidget extends StatefulWidget {
  const Profile18UserDetailsOtherWidget({super.key});

  @override
  State<Profile18UserDetailsOtherWidget> createState() =>
      _Profile18UserDetailsOtherWidgetState();
}

class _Profile18UserDetailsOtherWidgetState
    extends State<Profile18UserDetailsOtherWidget>
    with TickerProviderStateMixin {
  late Profile18UserDetailsOtherModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Profile18UserDetailsOtherModel());
